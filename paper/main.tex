...
\begin{figure}[h]%
    \centering
    \subfloat[\centering Scene from Marmara Earthquake ]{{\includegraphics[width=7.1cm]{paper/figures/earthquake_marmara2.jpeg} }}%
    \qquad
    \subfloat[\centering Regions Affected]{{\includegraphics[width=7.1cm]{paper/figures/marmara_affected.jpeg} }}%
