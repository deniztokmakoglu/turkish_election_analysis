...
reg3 <- felm(percent_turnout ~ treat_post | city + year_int, data = election_all3)
...
reg4 <- felm(swing ~ treat_post | city + year_int, 
             data = election_all4)
...
reg5 <- felm(incumbent_vote_share ~ treat_post | city + year_int , 
             data = election_all5)

reg6 <- felm(change_vote ~ treat_post | city + year_int, 
             data = election_all5)
...
reg1_1 <- felm(incumbent_vote_share ~ treat_post_kurdish | city + year_int, 
             data = dummies)
reg1_2 <- felm(incumbent_vote_share ~ event_earthquake | city + year_int, 
             data = dummies)
reg1_3 <- felm(incumbent_vote_share ~ treat_post_cyprus | city + year_int, 
             data = dummies)
reg1_4 <- felm(incumbent_vote_share ~ treat_post_refugee | city + year_int, 
             data = dummies)

stargazer(reg1_1, reg1_2, reg1_3, reg1_4, type = 'text')
